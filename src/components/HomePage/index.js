...
function HomePage() {
  ...
  return (
    <div className="home-page">
      ...
      />
      <div className="nav">
        <div onClick={scrollExperience} className="nav-link">
          Past Experience
        </div>
        <div onClick={scrollProjects} className="nav-link">
          Projects
        </div>
        <div onClick={scrollSkills} className="nav-link">
          Skills
        </div>
        <a href="mailto:owiwamasa@gmail.com" className="email-contact">
          owiwamasa@gmail.com
        </a>
      </div>
      <HeaderSection />
      ...
      <Element name="scrollToExperience">
        <PastExperience />
      </Element>
